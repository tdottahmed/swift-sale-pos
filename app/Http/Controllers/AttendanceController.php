...
class AttendanceController extends Controller
{
    ...
    public function showAttendance()
    {
        ...
        {
            // Existing logic for validation and retrieving data

            $attendance = new Attendance();
            $attendance->user_id = $request->user_id;
            $attendance->check_in = now(); // Assuming you're using a time library
            $attendance->date = now(); // Assuming you're using a time library
            // $attendance->status = "marked"; // Set initial status
