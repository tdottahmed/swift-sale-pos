            ...
            <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
                <li class="nav-item">
                    <a href="#profitByProduct" class="nav-link active" data-toggle="tab"
                        ...
                        <i class="icon-cart mr-2"></i> Profit By Product
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#profitByCategories" class="nav-link" data-toggle="tab"
                        data-url="{{ route('reports.profit-by-category') }}">
                        <i class="icon-list mr-2"></i> Profit By Category
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#profitByBrands" class="nav-link" data-toggle="tab"
                        data-url="{{ route('reports.profit-by-brand') }}">
                        <i class="icon-package mr-2"></i> Profit By Brands
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#profitByDay" class="nav-link" data-toggle="tab"
                        data-url="{{ route('reports.profit-by-day') }}">
                        <i class="icon-calendar mr-2"></i> Profit By Day
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#profitByCustomer" class="nav-link" data-toggle="tab"
                        data-url="{{ route('reports.profit-by-customer') }}">
                        <i class="icon-users mr-2"></i> Profit By Customer
                    </a>
                </li>
            </ul>
