               ...
               <div class="row justify-content-between">
                  <div class="col-lg-4 customer">
                     <div class="input-group">
                        ...
                        <input list="customers" name="customer" id="customer" class="form-control" placeholder="select Customer">
                           <datalist id="customers">
                              @foreach ($customers as $customer)                                  
                               <option value="{{$customer->id}}">{{$customer->name}}</option>
                              @endforeach
                           </datalist>
                        <span class="input-group-append bg-blue-700" data-toggle="modal" data-target="#modal_form_horizontal">
