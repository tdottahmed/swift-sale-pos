                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <button class="btn  bg-indigo-800 mx-2"><i
                                    class="icon icon-pencil7 mr-2"></i>Quotation</button>
                            <button class="btn  bg-warning-800 mx-2"><i
                                    class="icon icon-pause mr-2"></i>Suspend</button>
                            {{-- <button type="submit" class="btn  bg-info-800 mx-2"><i class="icon icon-check mr-2"></i>Credit Sale</button> --}}
                            <button class="btn  bg-info-800"><i class="icon icon-history mr-2"></i>Recent
                                Sell</button>
                        </div>
                        <div class="col-lg-3">
