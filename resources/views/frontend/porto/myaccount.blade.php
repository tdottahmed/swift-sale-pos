                ...
                <div class="tab-pane fade" id="order" role="tabpanel">
                    <div class="order-content">
                        ...
                        <div class="order-table-container text-center">
                            <table class="table table-order text-left">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center p-0"> <a href="{{ route('frontend.orderDetail', $order->id)}}">{{ $order->id }}</a></td>
                                            <td class="text-center p-0">{{ \Carbon\Carbon::parse($order->created_at)->format('d M, Y') }}</td>
                            ...
                            <a href="{{route('frontend.products')}}" class="btn btn-dark">Go Shop</a>
                        </div>
                    </div>
                </div><!-- End .tab-pane -->
