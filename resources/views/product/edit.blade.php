    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <select name="color_id" id="color_id" class="form-control">
                ...
                <option value="{{ $color->id }}" {{ $color->id == $product->color_id ? 'selected' : '' }}>{{ $color->title }}</option>
                @endforeach
            </select>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <select name="size_id" id="size_id" class="form-control">
                ...
                <option value="{{ $size->id }}" {{ $size->id == $product->size_id ? 'selected' : '' }}>{{ $size->title }}</option>
                @endforeach
            </select>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="mb-3">
            ...
            <select name="barcode_type_id" id="barcode_type_id" class="form-control">
                ...
                <option value="{{ $barcodeType->id }}" {{ $barcodeType->id == $product->barcode_type_id ? 'selected' : '' }}>{{ $barcodeType->title }}</option>
                @endforeach
            </select>
        </div>
    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="number" class="form-control" name="expires_in" id="expires_in" value="{{ $product->expire_in }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <label for="expiry_period_unit">Expire Unit:</label>
                        <input type="text" class="form-control" name="expiry_period_unit" id="expiry_period_unit" value="{{ $product->expire_unit }}">
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="profit_margin" id="profit_margin" value="{{ $product->profit_margin }}">
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" name="location" id="location" value="{{ $product->location }}">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-lg-6">
                        <label for="product_locations">Product Location:</label>
                        <input type="text" class="form-control" name="product_locations" id="product_locations" value="{{ $product->product_locations }}">
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input-styled" value="1" name="enable_imei_or_serial" data-fouc>
                                        Enable IMEI
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input-styled" value="1" name="enable_imei" data-fouc>
                                        Not for Sale
                                    </label>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input-styled" value="1" name="manage_stock" data-fouc>
                                        Manage Stock
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="selling_price_tax_type" id="selling_price_tax_type" class="form-control select">
                        ...
                        <div id="varibale_product">
                            <table class="table table-bordered">
                                ...
                                <tbody id="multiple_variation">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm rounded-round btn-icon bg-danger-800 shadow d-none">
                            ...
                            <div class="row justify-content-end mt-2">
                                <div class="col-lg-2 text-right">
                                    <button type="button" class="btn btn-sm bg-indigo border-2 border-indigo btn-icon rounded-round legitRipple shadow mr-1" id="vriation_add"><i class="icon-plus3"></i></button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered" id="single_product">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" class="form-control" name="variation_sku" placeholder="Variation SKU">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="stock" placeholder="stock">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="purchase_inc" placeholder="Inc. Tax">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="purchase_exc" placeholder="Exc. Tax">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="selling_price" placeholder="Exc. Tax">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="profit_marging" placeholder="25%">
                                    </td>
                                    <td>
