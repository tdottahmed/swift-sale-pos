                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="Mr/Mrs/Miss" class="form-control" name="prefix" value={{$contact->prefix}}>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="First Name" class="form-control" name="first_name" value={{$contact->first_name}}>
                        </div>
                        <div class="col-3">
                            <label class="col-form-label ">Middle Name :</label>
                            <input type="text" placeholder="Middle Name" class="form-control" name="middle_name" value={{$contact->middle_name}}>
                        </div>
                        <div class="col-3">
                            <label class="col-form-label 3">Last Name :</label>
                            <input type="text" placeholder="Last Name" class="form-control" name="last_name" value={{$contact->last_name}}>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="Mobile" class="form-control" name="mobile" value={{$contact->mobile}}>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="Landline" class="form-control" name="landline" value={{$contact->landline}}>
                        </div>
                        <div class="col-3">
                            <label class="col-form-label 3">Email :</label>
                            <input type="email" placeholder="Email" class="form-control" name="email" value={{$contact->email}}>
                    ...
                    <div class="form-group row">
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="City" class="form-control" name="city" value={{$contact->city}}>
                        </div>

                        <div class="col-3">

                            <label class="col-form-label">State :</label>
                            <input type="text" placeholder="State" class="form-control" name="state" value={{$contact->state}}>

                        </div>
                        <div class="col-3">
                            <label class="col-form-label ">Country :</label>
                            <input type="text" placeholder="Country" class="form-control" name="country" value={{$contact->country}}>
                        </div>
                        <div class="col-3">
                            <label class="col-form-label 3">Zip :</label>
                            <input type="text" placeholder="Zip" class="form-control" name="zip" value={{$contact->zip}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" placeholder="Assigned To" class="form-control" name="assigned_to" value={{$contact->assigned_to}}>

                        </div>
                        <div class="col-3">
                            <label class="col-form-label ">Address :</label>
                            <input type="text" placeholder="Address" class="form-control" name="address" value={{$contact->address}}>
                        </div>
                        <div class="col-3">
                            <label class="col-form-label 3">Address2 :</label>
                            <input type="text" placeholder="Address2" class="form-control" name="address2" value={{$contact->address2}}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" placeholder="Shipping Address" class="form-control" name="shipping_address" value={{$contact->shipping_address}}>
                                </div>
                            </div>
                        </div>
                    </div>
